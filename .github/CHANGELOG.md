...
6. [package-lock.json + package.json]: build(deps): bump react-router-dom from 6.16.0 to 6.17.0
7. [package-lock.json + package.json]: build(deps): bump vite from 2.9.16 to 4.5.0